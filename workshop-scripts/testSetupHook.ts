...
const beforeEachTestSeeds = {
  ...
  'cypress/e2e/02_intercepting_requests/02_dynamic_mocking/challenge.cy.ts': threeBoardsSingleListSingleCard,
  'cypress/e2e/02_intercepting_requests/02_dynamic_mocking/challenge_solution.cy.ts': threeBoardsSingleListSingleCard,
  'cypress/e2e/02_intercepting_requests/03_advanced_matching/demo_start.cy.ts': singleBoardTwoListsFiveCards,
  'cypress/e2e/02_intercepting_requests/03_advanced_matching/demo_end.cy.ts': singleBoardTwoListsFiveCards,
  'cypress/e2e/02_intercepting_requests/03_advanced_matching/challenge.cy.ts': singleBoardTwoListsFiveCards,
  'cypress/e2e/02_intercepting_requests/03_advanced_matching/challenge_solution.cy.ts': singleBoardTwoListsFiveCards,
  'cypress/e2e/02_intercepting_requests/04_tips_and_tricks/demo_start.cy.ts': singleBoardTwoListsFiveCards,
  'cypress/e2e/02_intercepting_requests/04_tips_and_tricks/demo_end.cy.ts': singleBoardTwoListsFiveCards,
